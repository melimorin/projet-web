    ...
    <div class="container container-admin-color espace-titre">
      ...
      ?>
        ...
        <ul class="list-group text-list">
            <li class="list-group-item">Madam Razal</li>
            <li class="list-group-item">Aime moi comme tu french</li>
            <li class="list-group-item">La vie d’Alex Joset </li>
            <li class="list-group-item">Sic Sic Sic</li>
        </ul>
    </div>
    <!-- Footer -->
    <?php 
